...
/***/ function(module, exports, __webpack_require__) {
	...
	var _common = __webpack_require__(160);
	...
	var WTFVIZ = function (_React$Component) {
	  _inherits(WTFVIZ, _React$Component);

	  function WTFVIZ(props) {
	    _classCallCheck(this, WTFVIZ);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(WTFVIZ).call(this, props));

	    _this.state = { embargo: 0, step: 10, feed: [], moreExists: true };
	    _this.initialLoad();
	    return _this;
	  }
	    ...
	    value: function initialLoad() {
	      ...
	      _jquery2.default.ajax({
	        ...
	        success: function success(data) {
	          _this2.setState({ feed: data.itemList });
	          _this2.loadMore();
	        }
	      });
	    }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            this.state.feed.slice(0, this.state.embargo).map(function (q, i) {
	              return _react2.default.createElement(_item2.default, _extends({}, q, { index: i }));
	            })
	          )
	        ),
	        function () {
	          switch (_this3.state.moreExists) {
	            case true:
	              return _react2.default.createElement(
	                'div',
	                ...
	                _react2.default.createElement(
	                  'button',
	                  { onClick: _this3.loadMore.bind(_this3) },
	                  'more'
	                )
	              );
	          }
	...
	_reactDom2.default.render(_react2.default.createElement(WTFVIZ, null), document.getElementById('react'));
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              "a",
	              { href: "https://github.com/infovis-kr", target: "_blank" },
	              "Infovis-kr"
	            ),
	            "."
	          )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Item = function (_React$Component) {
	  ...
	  _createClass(Item, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(ImageItem, this.props);
	    }
	  }]);
	...
	var ImageItem = function (_React$Component2) {
	  _inherits(ImageItem, _React$Component2);

	  function ImageItem() {
	    _classCallCheck(this, ImageItem);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ImageItem).apply(this, arguments));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js?indentedSyntax=true&outputStyle=compressed!./wtfviz.sass", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js?indentedSyntax=true&outputStyle=compressed!./wtfviz.sass");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html,body,button{color:#333333;font-size:15px;line-height:1.5;font-family:'Open Sans', sans-serif}a{color:#2f7bbf;text-decoration:none}a:hover{color:#ff7900}.app-wrapper{background:#e6e6e6}.wrapper{width:996px;margin:0 auto}#header{border-top:2px solid #ff7b7b;padding:0.5em 0;position:fixed;top:0;left:0;right:0;background:#ffffff;clear:both;overflow:hidden;border-bottom:1px solid #e6e6e6;z-index:11}#header>.wrapper{position:relative}#header .logo{font-size:1.13333em;line-height:2;position:absolute;top:0.2rem;left:50%;margin-top:0;margin-left:-82px;width:164px;text-align:center;color:#333333}#header .github{display:block;float:right}#header .github:hover{color:#333333}#header .github>i{font-size:0.9em;line-height:3em}#body{padding:3.5em 0 4em}#footer{background:#ffffff;padding:2.33333rem 0}#footer p{font-size:0.86667rem;text-align:right;margin:0;padding:0}.item-list .item{background:#ffffff;border:1px solid #dedede;border-radius:2px;margin-top:1.5em}.item-list .item .item-header{padding:1.5em;position:relative}.item-list .item .item-header .item-title{margin:0 0 1rem 0;font-weight:400;font-size:1.46667rem;line-height:1.3}.item-list .item .item-body{padding:1.5em;padding-top:0;position:relative}.more{padding:0 0 3em}.more button{display:block;margin:0 auto;background:#2f7bbf;border:1px solid #2f7bbf;border-radius:2px;color:#ffffff;padding:0.4em 1em 0.53333em;font-size:0.93333rem;font-weight:400;line-height:1.2}\n", ""]);
